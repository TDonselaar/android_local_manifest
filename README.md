...
curl -o .repo/local_manifests/manifest_brcm_rpi.xml -L https://raw.githubusercontent.com/TDonselaar/android_local_manifest/android-15.0.0_r14/manifest_brcm_rpi.xml --create-dirs
```
...
curl -o .repo/local_manifests/manifest_brcm_rpi.xml -L https://raw.githubusercontent.com/TDonselaar/android_local_manifest/android-15.0.0_r14/manifest_brcm_rpi.xml --create-dirs
curl -o .repo/local_manifests/remove_projects.xml -L https://raw.githubusercontent.com/TDonselaar/android_local_manifest/android-15.0.0_r14/remove_projects.xml
```
